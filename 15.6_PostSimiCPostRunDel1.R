...
tmp <- rbind(FetchData(post_data  , vars=c('Cluster_names', 'cell_5q', 'Sample')),
             FetchData(MDS_data   , vars=c('Cluster_names', 'cell_5q', 'Sample')),
             FetchData(pre_post_data , vars=c('Cluster_names', 'cell_5q', 'Sample')))
tmp$cell_id <- rownames(tmp)

tmp$Case <- ifelse(tmp$cell_id %in% colnames(MDS_data), 'MDS', 
            ifelse(tmp$Sample == 'FS-0406-post', 'PR', 
            ifelse(tmp$Sample == 'SMD211420', 'Pre', 'Post')))
seurat_data <- tmp
...
phenotypes <- c('MDS', 'PR', 'Pre', 'Post')
color_map <- c("#5f0f40","#9a031e","#e36414","#0f4c5c")
...
weights_file <- './Data/SimiC/Results/POST_Run_Del1_1000_L10.01_L20.01_Ws_filtered_BIC.pickle'
SimiC_weights <- py_load_object(filename =weights_file)
pd <- import("pandas")
AUCs_file <-'./Data/SimiC/Results/POST_Run_Del1_1000_L10.01_L20.01_AUCs.pickle'
...
pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del1/Simic_Filtered_R2_targets_hist_PostDel1.pdf'))
for (phenotype in phenotypes){
...
pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del1/Simic_TF_weigths_PostDel1.pdf'), onefile = TRUE, width=20)
TF_2_remove <- c()
...
# pdf(paste0('./Plots/SimiC/Simic_TF_stats_PostDel1.pdf'), onefile = TRUE)
...
pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del1/Simic_Targets_weigths_PostDel1.pdf'), onefile = TRUE, width=20)
plot_counter <- 1
plot_list <- list()
...
# AUCs <- list()
# for(i in seq_along(phenotypes)){
# 	AUCs[[i]] <- read.table(paste0('./Data/SimiC/Results//PostDel1_1000_L10.01_L20.01_AUCs_', assignment[[i]], '_BIS.csv'), header=T, sep='\t')
# }
...
pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del1/Simic_Population_phenotype_PostDel1.pdf'))
...
for (clust in clusters_2_keep){
  ...
  pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del1/Simic_Auc_Cluster_',clust,'_PostDel1.pdf'), width = 15, onefile = TRUE)
  plot_counter <- 1
...
saveRDS(df_auc, '/home/tereshkova/data/gserranos/MDS/Data/SimiC_df_auc_PostDel1.rds')

pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del1/Simic_Auc_all_cells_PostDel1.pdf'), width = 15, onefile = TRUE)
plot_counter <- 1
plotter2 <- df_auc
for (tf in unique(plotter2$driver)){
	message(tf)
...
# pdf(paste0('./Plots/SimiC/Simic_Auc_all_cells_perPatient_PostDel1.pdf'), width = 15, onefile = TRUE)
# plot_counter <- 1
# for (tf in unique(plotter2$driver)){
# 	assign( paste0('p', plot_counter), 
# 	ggplot(plotter2[plotter2$driver ==tf,], aes(x=value, fill=TimePoint)) + 
...
saveRDS(MinMax_clust, '/home/tereshkova/data/gserranos/MDS/Data/SimiC_MinMax_clust_PostDel1.rds')
...
pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del1/Simic_HeatMaps_RegDissScore_PostDel1.pdf'), height = plot_dims$height, width = plot_dims$width )
print(p)
dev.off()
...
# pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del1/Simic_tSNE_selection_PostDel1.pdf'), height =8, width=18)
...
saveRDS(SimiC_weights_df,  '/home/tereshkova/data/gserranos/MDS/Data/SimiC_Weigths_PostDel1.rds')
saveRDS(unselected_targets, '/home/tereshkova/data/gserranos/MDS/Data/SimiC_unselected_targets_PostDel1.rds')

pdf('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del1/Enrich_Regulons_PostDel1.pdf')
