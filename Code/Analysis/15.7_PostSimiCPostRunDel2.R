...
weights_file <- './Data/SimiC/Results/POST_Run_Del2_1000_L10.01_L20.01_Ws_filtered_BIC.pickle'
SimiC_weights <- py_load_object(filename =weights_file)
pd <- import("pandas")
AUCs_file <-'./Data/SimiC/Results/POST_Run_Del2_1000_L10.01_L20.01_AUCs.pickle'
...
pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del2/Simic_Filtered_R2_targets_hist_PostDel2.pdf'))
for (phenotype in phenotypes){
...
pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del2/Simic_TF_weigths_PostDel2.pdf'), onefile = TRUE, width=20)
TF_2_remove <- c()
...
# pdf(paste0('./Plots/SimiC/Simic_TF_stats_PostDel2.pdf'), onefile = TRUE)
...
pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del2/Simic_Targets_weigths_PostDel2.pdf'), onefile = TRUE, width=20)
plot_counter <- 1
plot_list <- list()
...
# AUCs <- list()
# for(i in seq_along(phenotypes)){
# 	AUCs[[i]] <- read.table(paste0('./Data/SimiC/Results//PostDel2_1000_L10.01_L20.01_AUCs_', assignment[[i]], '_BIS.csv'), header=T, sep='\t')
# }
...
pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del2/Simic_Population_phenotype_PostDel2.pdf'))
...
for (clust in clusters_2_keep){
  ...
  pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del2/Simic_Auc_Cluster_',clust,'_PostDel2.pdf'), width = 15, onefile = TRUE)
  plot_counter <- 1
...
saveRDS(df_auc, '/home/tereshkova/data/gserranos/MDS/Data/SimiC_df_auc_PostDel2.rds')

pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del2/Simic_Auc_all_cells_PostDel2.pdf'), width = 15, onefile = TRUE)
plot_counter <- 1
plotter2 <- df_auc
for (tf in unique(plotter2$driver)){
	message(tf)
...
# pdf(paste0('./Plots/SimiC/Simic_Auc_all_cells_perPatient_PostDel2.pdf'), width = 15, onefile = TRUE)
# plot_counter <- 1
# for (tf in unique(plotter2$driver)){
# 	assign( paste0('p', plot_counter), 
# 	ggplot(plotter2[plotter2$driver ==tf,], aes(x=value, fill=TimePoint)) + 
...
saveRDS(MinMax_clust, '/home/tereshkova/data/gserranos/MDS/Data/SimiC_MinMax_clust_PostDel2.rds')
...
pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del2/Simic_HeatMaps_RegDissScore_PostDel2.pdf'), height = plot_dims$height, width = plot_dims$width )
print(p)
dev.off()
...
# pdf(paste0('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del2/Simic_tSNE_selection_PostDel2.pdf'), height =8, width=18)
...
saveRDS(SimiC_weights_df,  '/home/tereshkova/data/gserranos/MDS/Data/SimiC_Weigths_PostDel2.rds')
saveRDS(unselected_targets, '/home/tereshkova/data/gserranos/MDS/Data/SimiC_unselected_targets_PostDel2.rds')

pdf('/home/tereshkova/data/gserranos/MDS/Plots/SimiC/Post/Del2/Enrich_Regulons_PostDel2.pdf')
