...
parser$add_argument('-S', '--SampleName', default="SMD34459", type="character",
                    help='Sample on the following path: ./Data/')
...
treated_samples <- c('SMD211420', 'SMD132114579')
...
message(paste0('Processing: ', args$SampleName))
...
if (SAMPLE == "SMD21949"){
	data_flt <- Read10X(data.dir = paste0('/home/tereshkova/data/gserranos/MDS/Data/',SAMPLE,'/filtered_gene_bc_matrices/GRCh38/'))
}else{
	data_flt <- Read10X(data.dir = paste0('/home/tereshkova/data/gserranos/MDS/Data/',SAMPLE,'/filtered_feature_bc_matrix/'))
}
